...
class RolesController extends Controller
{
    ...
    public function edit(Role $role)
    {
        ...
        $role->permissions = RoleHasPermission::getRolePermissionList($role->id);

        return view('admin.role.edit', [
            'role' => $role,
            'permissions' => Permission::getPermissionList($role->id)
        ]);
    }
    ...
    public function update(UpdateRole $request, Role $role)
    {
        ...
        $insert_has_permissions = collect($sanitized["permissions"])
        ...
        RoleHasPermission::insert($insert_has_permissions);
